...
# value_counts() retorna a contagem de quantas vezes cada possível valor daquela coluna aparece
def infected():
...
# quantidade de pacientes por ala
...
# quantidade de infectados por virus
...
# gráfico de pizza (plt.pie) que recebe os valores das contagens da primeira linha do código
def result():
